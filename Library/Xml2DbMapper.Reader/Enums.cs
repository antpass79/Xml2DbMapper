...
namespace Xml2DbMapper.Reader
{
	public class Enums
	{
		...
		{
			Native = Enums.StudyFormat.Native,
			Dicom = Enums.StudyFormat.Dicom
		}
		...
		public static bool IsCardiacApplication(Enums.ApplicationType p_Application)
		{
			switch (p_Application)
			{
				case Enums.ApplicationType.Cardiac:
				case Enums.ApplicationType.CardiacPediatric:
				case Enums.ApplicationType.CardioCanine:
				case Enums.ApplicationType.CardioEquine:
				case Enums.ApplicationType.CardioFeline:
				case Enums.ApplicationType.OtherCardio:
					return true;
		...
		static public bool IsApplicationCardiac(Enums.ApplicationType p_Application)
		{
			if (p_Application == Enums.ApplicationType.Cardiac ||
					p_Application == Enums.ApplicationType.CardiacPediatric ||
					p_Application == Enums.ApplicationType.CardioCanine ||
					p_Application == Enums.ApplicationType.CardioFeline ||
					p_Application == Enums.ApplicationType.CardioEquine ||
					p_Application == Enums.ApplicationType.CardioBovine ||
					p_Application == Enums.ApplicationType.OtherCardio)
			{
				return true;
			}
